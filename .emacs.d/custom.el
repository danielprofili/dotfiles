(custom-set-variables
 ...
 '(package-selected-packages
   '(eaf-browser yasnippet-snippets writeroom-mode which-key telephone-line projectile powerline ox-twbs org-ref org-evil magit ivy highlight-indent-guides helm focus evil-surround evil-better-visual-line disable-mouse dired-git-info delight company benchmark-init backward-forward auctex ample-theme)))
(custom-set-faces
