(custom-set-variables
 ...
 '(evil-motion-state-modes
   '(apropos-mode color-theme-mode command-history-mode dictionary-mode ert-results-mode undo-tree-visualizer-mode))
 ...
 '(helm-type-buffer-actions
   '(("Switch to buffer(s)" . helm-buffer-switch-buffers)
     ...
     ("Raise buffer frame maybe" . helm-buffers-maybe-raise-buffer-frame)
     ("Switch to buffer(s) other tab `C-c C-t'" . helm-buffers-switch-to-buffer-other-tab)
